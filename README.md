...
- Generative AI / LLM applications (RAG systems, AI assistants, knowledge tools)  
- Computer vision (detection, segmentation, tracking, visual understanding)  
- Applied ML systems involving physics-informed neural networks (PINNs), optimization methods, and inverse problems  
